...
<template>
  ...
  <v-card class="mx-auto" max-width="1000" tile>
    <v-avatar :rounded="5" size="150">
      <v-img :width="800" aspect-ratio="16/9" src="https://cdn.vuetifyjs.com/images/parallax/material.jpg"></v-img>
    </v-avatar>
  ...
  <v-dialog persistent :model-value="isEdit" width="800">
    <v-card class="rounded-lg elevation-5">
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn variant="flat" color="secondary" @click="isEdit ? closeEdit() : false">Close</v-btn>
