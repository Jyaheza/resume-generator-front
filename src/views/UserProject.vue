...
<template>
  ...
  <v-container>
    <div id="body">
      ...
      <v-card v-if="!loading && projects.length > 0" class="rounded-lg elevation-5">
        <v-card-text>
      ...
      <v-col v-else-if="!loading && projects.length === 0" class="text-h5 text-center">
        <span>Add Projects to your profile.</span>
      </v-col>
